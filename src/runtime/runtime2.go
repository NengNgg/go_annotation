...
type itab struct {
	...
	hash  uint32         // copy of _type.hash. Used for type switches. 用于断言匹配类型是否一致的哈希值
	_     [4]byte
	fun   [1]uintptr // variable sized. fun[0]==0 means _type does not implement inter. 实现接口的类型函数地址
}
